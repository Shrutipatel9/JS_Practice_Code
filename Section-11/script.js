...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    alert('Inserted pin is incorrect! Please insert correct pin');
    inputLoginPin.value = ' ';
...
//   const humanAge = dog.map(dage => (dage <= 2 ? 2 * dage : 16 + dage * 4));
...
console.log(dogs.some(dog => dogs.curFood === dog.recFood));
...
// console.log(dogs.find(checkEatingOkay));
